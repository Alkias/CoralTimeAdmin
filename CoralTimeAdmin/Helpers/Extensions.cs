...
namespace CoralTimeAdmin.Helpers
{
    public static class Extensions
    {
        ...
        /// <summary>
        /// Convert a strin type "15/05/2018"
        /// to sql 2018-05-15 if culture is el or el-GR
        /// </summary>
        /// <param name="str"></param>
        /// <returns></returns>
        public static string ToSqlDateTimeFormat(this string str)
        {
            ...
            try
            {
                ...
                var time = DateTime.Parse(str, currentCulture);
                string sqlFormattedDate = time.ToString("yyyy-MM-dd");
        ...
        public static string MaskExceptLastChars(this string str, int lastChars = 3)
        {
            if (str == null)
                return null;
            var newString = "";
        ...
        public static string MaskEmails(this string email, int lastChars = 2)
        {
            if (email == null)
                return null;
        ...
        public static T FromJson<T>(this object json) => JsonConvert.DeserializeObject<T>(json.ToString());
