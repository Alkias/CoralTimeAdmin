...
{
    /// <summary>
    /// A class that finds types needed by IntelliCms by looping assemblies in the
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>
        /// Gets or sets whether IntelliCms should iterate assemblies in the app domain when loading IntelliCms types. Loading patterns
        ...
        /// </summary>
        /// <remarks>
        /// If you change this so that IntelliCms assemblies arn't investigated (e.g. by not including something like "^IntelliCms|..."
        ...
        /// <returns>A list of assemblies that should be loaded by the IntelliCms factory.</returns>
        ...
        private void AddAssembliesInAppDomain(List<string> addedAssemblyNames,
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into IntelliCms.
        /// </returns>
        ...
        protected virtual bool DoesTypeImplementOpenGeneric(Type type,
            ...
            try {
                ...
                foreach (var implementedInterface in type.FindInterfaces((objType,
                        objCriteria) => true,
                    null)) {
